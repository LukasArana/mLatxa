...
swift export \
    ...
    --dataset magpie_llama hplt_v1 booktegi cultura-x egunkaria wikipedia euscrawl_v1.1 oscar \
    --template qwen \
    --max_length 8192 \
    --dataset_num_proc 16 \
    --to_cached_dataset \
    --output_dir /leonardo_work/AIFAC_5C0_261/datasets/train/preprocessed/v1/