...
export WANDB_PROJECT="gemma-4-E4B-it"
...
srun accelerate launch \
    ...
    --model /leonardo_work/AIFAC_5C0_261/baseModels/gemma-4-E4B-it/ \
    ...
    --output_dir /leonardo_work/AIFAC_5C0_261/multimodalModels/gemma-4-E4B-it/ \
    --save_steps 250 \
    --max_length 8192 \
