...
export TMPDIR="/leonardo_work/AIFAC_5C0_261/aimar/tmp"
export HF_HOME="/leonardo_work/AIFAC_5C0_261/.cache_aimar"
...
srun accelerate launch \
    ...
    /leonardo/home/userexternal/asagasti/ms-swift/swift/cli/_megatron/sft.py \
    --model /leonardo_work/AIFAC_5C0_261/baseModels/Qwen3.5-9B \
    --save_safetensors true \
    --cached_dataset /leonardo_work/AIFAC_5C0_261/datasets/preprocess_v1/train \
    ...
    --output_dir /leonardo_work/AIFAC_5C0_261/latxa-qwen3.5_v1 \
    --save_steps 250 \
    --max_length 8192 \
    ...
    --mcore_model /leonardo_work/AIFAC_5C0_261/latxa-qwen3.5_v1/v1-20260327-125457/checkpoint-1911/
